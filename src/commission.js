...
//
// Note: this deliberately does NOT check for an available top-scorer
// free-commission credit (see src/top-scorer-promotion-scheduler.js) —
// that's a one-time, consumable credit applied directly in
// POST /payouts/request in payments.routes.js, not a standing rate. This
// function gets called from read-only contexts too (e.g. admin
// transaction estimates), which should never accidentally consume a
// credit just by being viewed.
